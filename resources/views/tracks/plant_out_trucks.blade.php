...
<button type="button" class="btn btn-danger btn-sm btn-block" data-toggle="modal" data-target="#myModal-{{$track->id}}">Plant out</button>
...
<tr>
    <td colspan="6">
        <em>
    <h3 class="text-center" style="font-weight: bold">No Truck Out for this day!</h3>
</em>
    </td>
</tr>
