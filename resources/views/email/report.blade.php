                                    ...
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        <!-- Intro -->
                                            ...
                                            <table class="report-table" width="100%">
											  <tr>
											    <th rowspan="2">Total Dispatch</th>
											    <th colspan="2">Within the Plant</th>
											    <th colspan="2">Within the Customer</th>
											  </tr>
											   <tr>
											    <th>IN</th>
											    <th>OUT</th>
											  ...
											  <tr>
											    <td>{{$total_track}}</td>
											    <td>{{$total_plantin}}</td>
											    <td>{{$total_plantout}}</td>
											    <td>{{$total_customerin}}</td>
											    <td>{{$total_customerout}}</td>
											  </tr>
